    ...
    <div className="absolute inset-0 z-40 flex flex-col overflow-y-auto bg-neutral-950/95 p-5 pt-[max(1.25rem,env(safe-area-inset-top))] text-sm text-neutral-200">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>반복 동작은 시작을 누르고 자리를 잡은 뒤 <b>5~8회를 연속</b>으로 하고 완료를 누릅니다. 회를 자동으로 찾아 칩으로 보여주고, 회마다 샘플 하나가 저장됩니다. 한 녹화는 60초까지입니다.</li>
          <li>회마다 시작·끝, 그리고 <b>바닥(가장 깊이 굽힌 순간)</b>을 정확히 잡을수록 좋습니다. 슬라이더는 선택한 회 주변만 다루고 ◀▶로 한 프레임씩 맞춥니다. 구간 밖에서 운동과 다른 자세(걷기 등)는 자동으로 “아무것도 아님”이 됩니다.</li>
